...
Interactive network graph that turns your GitHub and Discord connections into a visual map of people, skills, and shared context.

## Status — Milestone 1

- **Data model** — `Person` nodes (name, avatar, headline, company, contact, skills, interests, tags, notes, links, GitHub/Discord handles) and typed `Edge` relationships carrying first-class context metadata: how you know someone (`origin`), free-text context, shared communities/servers, shared projects, tie strength, and when you met.
...
- [ ] Discord integration — shared server/community data onto edges
